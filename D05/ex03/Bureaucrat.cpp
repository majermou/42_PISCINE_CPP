...
/*   Updated: 2021/06/26 19:49:55 by majermou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Bureaucrat::executeForm(Form const & form)
{
    if (_grade > form.getGradeToexecute())
        std::cout   << "\033[0;33mI can't execute the form because I am not superior enough.\033[0m"
                    << std::endl;
    else if (form.getFormStatus() == false)
        std::cout   << "\033[0;33mI can't execute the form because it is not signed.\033[0m"
                    << std::endl;
    else
    {
        std::cout   << _name
